...
const GroupScreen = () => {
    ...
    const [selectedGroup, setSelectedGroup] = useState<GroupAll | null>(null);
    const [groupList, setGroupList] = useState<GroupAll[]>([]);
    ...
    const updateURL = useCallback(
        (group: GroupAll | null, subgroup: Subgroup | null, weekType: boolean) => {
            if (!group) return;
    ...
    const checkSubgroupAndSet = useCallback((group: GroupAll | null) => {
    ...
    const handleGroupSelect = (group: GroupAll | null) => {
    ...
    const handleGroupListFetched = (groups: GroupAll[]) => {
        setGroupList(groups);
    };
